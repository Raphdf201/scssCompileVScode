 ...
 */
const compileCurrent = commands.registerCommand("scss-compiler.compile-current-file", () => {
 ...
 */
const compileAll = commands.registerCommand("scss-compiler.compile-all", async () => {
